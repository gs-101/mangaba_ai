...
class MangabaChannelAnalyzer:
    def __init__(
        self, bot_token: str = None, workspace_id: str = None, channel_id: str = None
    ):
        """
    ...
    def analyze_channel(self, channel_id: str):
        ...
        try:
            ...
            if e.response["error"] == "missing_scope":
                ...
                error_message = (
                    f"Channel {channel_id} not found. Please check the channel ID."
                )
    ...
    def _analyze_messages(self, messages: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        for msg in messages:
            ...
            if (
                len(text.split()) > 10
            ):  # Consider longer messages as potential key discussions
