...
async def test_agent_message_processing():
    ...
    agent = Agent()
    message = Message(
        content="Teste de mensagem", sender="TestUser", timestamp="1234567890"
    )
...
async def test_mcp_conversation_analysis():
    ...
    mcp = MCP()
    messages = [
        Message(content="Primeira mensagem", sender="User1", timestamp="1234567890"),
        Message(content="Segunda mensagem", sender="User2", timestamp="1234567891"),
    ]
