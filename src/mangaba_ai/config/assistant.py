...
class ConfigAssistant:
    ...
    def _create_new_config(self):
        ...
        self.config = {"api_keys": {}, "models": {}, "integrations": {}}
    ...
    def _configure_apis(self):
        ...
        for api, guide in self.setup_guides.items():
            ...
            open_browser = input(
                f"Deseja abrir a página de configuração do {api.upper()}? (s/n): "
            )
    ...
    def _configure_models(self):
        ...
        for api in self.config["api_keys"].keys():
            ...
            default_config = {
                "gemini": {"temperature": 0.7, "top_k": 40, "top_p": 0.95},
            ...
            use_default = input(
                f"Deseja usar configurações padrão para {api.upper()}? (s/n): "
            )
    ...
    def _configure_integrations(self):
        ...
        integrations = {
            ...
            "discord": {"token": "Token do Bot", "guild_id": "ID do Servidor"},
        }
