...
# Dados de exemplo
DADOS_VENDAS = {
    "Q1": {"janeiro": 15000, "fevereiro": 18000, "março": 22000},
    "Q2": {"abril": 25000, "maio": 28000, "junho": 30000},
    "Q3": {"julho": 32000, "agosto": 35000, "setembro": 38000},
}
...
async def main():
    ...
    try:
        ...
        tarefa_coleta = ai.create_task(
            ...
            agent=coletor,
            context={"dados": DADOS_VENDAS, "periodo": "Q3", "validar": True},
        )
        ...
        resultados = await ai.execute(
            [tarefa_coleta, tarefa_analise, tarefa_estrategia]
        )
