...
from src.integrations.slack.mangaba_channel_analyzer import \
    MangabaChannelAnalyzer
...
class TestSlackIntegration(unittest.TestCase):
    ...
    def test_message_retrieval(self):
        ...
        try:
            result = self.client.conversations_history(channel=self.channel_id, limit=5)
    ...
    def test_message_sending(self):
        ...
        try:
            result = self.client.chat_postMessage(
                channel=self.channel_id, text="Test message from integration test"
            )
